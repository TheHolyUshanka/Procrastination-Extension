...
async function createBox() {
  ...
  minimizeButtonDiv.setAttribute("style", "all: initial; min-height: 5px; height: 0.4vh; " + 
  "width: 15%; cursor: pointer; align-self: flex-end; padding: max(0.75vh, 8px); box-sizing: border-box;")
